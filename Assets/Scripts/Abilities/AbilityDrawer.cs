...
namespace Abilities
{
    ...
    public class AbilityDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (EditorGUI.DropdownButton(typeRect, new GUIContent(displayName ?? "Select Ability Type"),
                    FocusType.Keyboard))
            {
        ...
        // Returns enough space for the dropdown button + whatever the nested property needs.
